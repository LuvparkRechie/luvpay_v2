...
class CustomDialogStack {
  ...
  static void showConfirmationRaw({
    ...
    _showBaseDialogTracked(context, title, subtitle,
        image ?? "dialog_confirmation", leftButtonAction,
  ...
  static void showInfo(
    ...
    _showBaseDialogTracked(context, title, subtitle,
        image ?? "dialog_information", leftButtonAction,
        leftText: leftText, showRightButton: false);
  }
  ...
  static void showSuccess(
    ...
    _showBaseDialogTracked(
        context, title, subtitle, image ?? "dialog_success2", leftButtonAction,
        leftText: leftText, showRightButton: false);
  }
  ...
  static void showError(BuildContext context, String title, String subtitle,
      VoidCallback leftButtonAction) {
    _showBaseDialogTracked(
        context, title, subtitle, "dialog_notice", leftButtonAction,
        leftText: "Okay", showRightButton: false);
  }

  static void showServerError(
      BuildContext context, VoidCallback leftButtonAction) {
    _showBaseDialogTracked(
        context,
        "Server error",
  ...
  static void showComingSoon(BuildContext context, VoidCallback onClose) {
    _showBaseDialogTracked(context, "Coming Soon",
        "This feature isn’t available yet.", "dialog_information", onClose,
        leftText: "Okay", showRightButton: false);
  }
