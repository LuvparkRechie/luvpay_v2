                                                    ...
                                                    child: Neumorphic(
                                                        style: NeumorphicStyle(
                                                            ...
                                                            intensity: isDark
                                                                ? 0.40
                                                                : 0.48,
                                                            surfaceIntensity: isDark
                                                                ? 0.08
                                                                : 0.12),
                                                        child: SizedBox(
                                                            width: double.infinity,
                                                            height: 54,
                                                            child: Center(child: LuvpayText(text: widget.buttonText, color: cs.onPrimary, style: const TextStyle(fontSize: 14.5, fontWeight: FontWeight.w900, letterSpacing: 0.25)))))))),
                                        const SizedBox(height: 8),
                                      ])),
                            ])))))));
...
class _AnimatedBlob extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final floatAnim = CurvedAnimation(
        parent: controller,
        curve: Interval(phase, (phase + 0.6).clamp(0.0, 1.0),
        ...
        builder: (_, __) {
          ...
          return Positioned(
              ...
              child: Transform.scale(
                  scale: s, child: _Blob(size: size, color: color)));
        });
  }
}
