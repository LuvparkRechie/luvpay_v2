...
class AppTextStyle {
  ...
  static Color _primaryText(BuildContext context) => _isDark(context)
...
class LuvpayText extends StatefulWidget {
  ...
  @override
  State<LuvpayText> createState() => _DefaultTextState();
}

class _DefaultTextState extends State<LuvpayText> {
  @override
