...
class MerchantQRReceipt extends GetView<MerchantQRRController> {
            ...
            child: Padding(
                ...
                child: Column(children: [
                  ...
                  Screenshot(
                      ...
                      child: _buildTicketReceiptCard(context,
                          cs: cs,
                          isDark: isDark,
          ...
          Section(
              ...
              child: Column(children: [
                Container(
                    ...
                    child:
                        Icon(Icons.check_rounded, color: cs.primary, size: 32)),
                const SizedBox(height: 14),
                LuvpayText(
  ...
  Widget _detailRow(
      BuildContext context, ColorScheme cs, String label, String value) {
    return Padding(
    ...
    return SizedBox(
        ...
        child: OutlinedButton.icon(
            ...
            style: OutlinedButton.styleFrom(
                ...
                side: BorderSide(
                    color: cs.primary.withOpacity(isDark ? 0.55 : 0.75)),
  ...
  void _saveReceipt() async {
    ...
    try {
      final image = await _ticketController.capture(
          delay: const Duration(milliseconds: 250), pixelRatio: 3);
      ...
      CustomDialogStack.showSuccess(
          Get.context!, "Saved", "Receipt saved to gallery", () => Get.back());
    } catch (_) {
      if (Get.isDialogOpen == true) Get.back();
      CustomDialogStack.showError(Get.context!, "Error",
          "Failed to save receipt. Please try again.", () => Get.back());
    }
  }
