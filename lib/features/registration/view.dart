...
import 'package:luvpay/features/registration/controller.dart';
            ...
            child: ScrollConfiguration(
                ...
                child: StretchingOverscrollIndicator(
                    ...
                    child: SingleChildScrollView(child:
                        GetBuilder<RegistrationController>(builder: (ctxt) {
                      return Form(
  ...
  Column passwordStrength(Color Function(int strength) getColorForStrength) {
    return Column(children: [
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        if (Variables.getPasswordStrengthText(controller.passStrength.value)
            .isNotEmpty)
          Row(children: [
            LuvpayText(
                fontSize: 14,
            ...
            child:
              ...
              Row(children: [
                PasswordStrengthIndicator(
                    ...
                    color: getColorForStrength(controller.passStrength.value)),
                SizedBox(width: 5),
                PasswordStrengthIndicator(
                    strength: 2,
                    currentStrength: controller.passStrength.value,
