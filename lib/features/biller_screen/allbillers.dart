  ...
  Obx _favorites(BuildContext context) {
    ...
    return Obx(() {
      ...
      return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        LuvpayText(text: 'Favorites', style: AppTextStyle.h3(context)),
                      ...
                      child: Stack(clipBehavior: Clip.none, children: [
                        LuvNeuPress.rectangle(
                            onTap: () async {
                              ...
                              CustomDialogStack.showConfirmation(
                                ...
                                final resBill = await Get.to(() => BillerScreen(
                                    data: [mappedData], paymentHk: paymentHk));
                        ...
                        Positioned(
                            ...
                            child: LuvNeuPress.circle(
                                ...
                                onTap: () {
                                  controller.deleteFavoriteBiller(int.parse(
                        ...
                        Expanded(
                            child: TextField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    hintStyle: AppTextStyle.paragraph2(context)
                                        .copyWith(color: hint),
