...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void sendFileMessage(File file) {
    ...
    _controller.addMessage(ChatMessage(
        text: "📎 $fileName", user: _currentUser, createdAt: DateTime.now()));
  }
    ...
    return GestureDetector(
        onTap: () {
          handleSendMessage(ChatMessage(
              text: text, user: _currentUser, createdAt: DateTime.now()));
        },
        child: Container(
    ...
    return CustomScaffoldV2(
        ...
        bottom: PreferredSize(
            ...
            child: Column(children: [
              ...
              LuvpayText(
                  text: "Status: $status", color: getStatusColor(status)),
            ])),
                ...
                onSendMessage: (message) {
                  if (isClosed) {
                    CustomDialogStack.showSnackBar(
                        context, "This ticket is already closed.", null, null);
                    return;
                  }
