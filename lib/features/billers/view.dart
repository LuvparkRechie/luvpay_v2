...
class Billers extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScaffoldV2(
        appBarTitle: "Billers",
        enableToolBar: true,
        scaffoldBody: Obx(() => !controller.isNetConn.value
            ...
            : RefreshIndicator(
                ...
                child: Column(
                    ...
                    children: [
                      LuvpayText(
                          style: AppTextStyle.h3(context), text: "Pay Bills"),
                      SizedBox(height: 14),
                      InkWell(
                          onTap: () {
                          ...
                          child: Container(
                              decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                      width: 2, color: AppColorV2.lpBlueBrand)),
                                                          ...
                                                          Row(children: [
                                                            ...
                                                            Expanded(
                                                                child: LuvpayText(
                                                                    fontSize:
                                                                        10,
                                                                    text: controller.favBillers[index]["biller_address"] !=
                                                                            null
                                                                  ...
                                                                  children: [
                                                                    LuvpayText(
                                                                        ...
                                                                        fontWeight:
                                                                            FontWeight
                                                                                .w500,
                                                                        text: controller.favBillers[index]['account_name'] ??
                                                                            '',
                                                                        maxLines:
                                                                            1,
                                                                        overflow:
                                                              ...
                                                              children: [
                                                                ...
                                                                GestureDetector(
                                                                    ...
                                                                    child: Container(
                                                                        ...
                                                                        decoration: BoxDecoration(border: Border.all(color: AppColorV2.incorrectState), borderRadius: BorderRadius.circular(30)),
                                                                        child: Row(children: [
                                                                          Icon(
                                                                              size: 16,
    ...
    return Wrap(children: [
      Container(
          ...
          child:
            ...
            Row(children: [
              LuvpayText(text: "Sort by ", fontWeight: FontWeight.w600),
              LuvpayText(
              ...
              InkWell(
                  ...
                  child: Padding(
                      ...
                      child: Container(
                          ...
                          child: Row(children: [
                            Icon(option['icon'],
                                size: 25, color: AppColorV2.lpBlueBrand),
                            SizedBox(width: 10),
                            Expanded(child: LuvpayText(text: option['text'])),
