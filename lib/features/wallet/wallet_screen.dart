  ...
  Widget _favBillers(ColorScheme cs) {
    return Obx(() {
      ...
      final gradient = isDark
          ? const LinearGradient(colors: [Color(0xFF0078FF), Color(0xFF01DEEA)])
          : null;
      if (favs.isEmpty) return const SizedBox();
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: LuvpayText(
                            text: getInitials(fav["account_name"] ?? 'Unnamed'),
          ...
          decoration: BoxDecoration(
            ...
            gradient: isActive
                ? const LinearGradient(
                    colors: [Color(0xFF0078FF), Color(0xFF01DEEA)],
                  )
                : null,
...
class TransactionSectionListView extends StatelessWidget {
  ...
  Widget _buildTransactionItem(
    ...
    final accent = isPositive ? AppColorV2.lpTealBrand : AppColorV2.lpBlueBrand;
    final trailingColor =
        isPositive ? AppColorV2.lpBlueBrand : AppColorV2.incorrectState;
