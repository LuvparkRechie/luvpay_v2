  ...
  Future<void> _getVouchers() async {
    ...
    try {
      ...
      final results = await Future.wait([
        Functions().requestHandler(apiKey: availableApi),
        Functions().requestHandler(apiKey: usedApi),
        Functions().requestHandler(apiKey: expiredApi),
      ]);
                    ...
                    child: Center(
                        child: Padding(
                            ...
                            child: LuvpayText(
                                ...
                                style: AppTextStyle.h4(context),
                                color:
                                    cs.primary.withOpacity(isCE ? 0.45 : 0.95),
                                textAlign: TextAlign.center,
                                maxLines: 1)))),
                Section(
                    widthFactor: 3,
