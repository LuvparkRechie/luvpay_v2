...
class _VouchersState extends State<Vouchers> {
  ...
  void _claimVoucher() async {
    ...
    try {
      await voucherController.putVoucher(code, context, _textFieldKey,
          fromBooking: false);
      controller.clear();
  ...
  Widget _searchBar(
      BuildContext context, bool enabled, ColorScheme cs, bool isDark) {
