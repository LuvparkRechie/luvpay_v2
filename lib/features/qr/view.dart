                                                      ...
                                                      child: SizedBox(
                                                          ...
                                                          child: PrettyQrView(
                                                              decoration: const PrettyQrDecoration(
                                                                  background:
                                                                      Colors.white,
                                                                  image: PrettyQrDecorationImage(image: AssetImage("assets/images/logo.png"))),
                                                              qrImage: QrImage(QrCode.fromData(data: myQR ? widget.qrCode! : controller.payKey.value, errorCorrectLevel: QrErrorCorrectLevel.H))))),
                                            ...
                                            Obx(() => Padding(
                                                ...
                                                child: Column(children: [
                                                  CustomButton(
                                                      ...
                                                      text: controller.isButtonDisabled.value || (((controller.remainingTime.value % 60000) / 1000).floor() != 0)
