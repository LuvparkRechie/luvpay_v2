    ...
    return Obx(() {
      ...
      return CustomScaffoldV2(
          ...
          bottom: PreferredSize(
              preferredSize: const Size.fromHeight(90), child: index(context)));
    });
  }
            ...
            return Expanded(
              ...
              Row(children: [
                if (i != 0)
                  Expanded(
                      child: Container(
                          height: 2, color: enabled ? activeDot : inactiveDot)),
                Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color:
                                cs.onPrimary.withOpacity(isDark ? 0.05 : 0.01),
                            width: 1)),
                    child: Center(
                        child: LuvpayText(
                            text: '${i + 1}',
                ...
                if (i != 2)
                  Expanded(
                      child: Container(
                          height: 2, color: passed ? activeDot : inactiveDot)),
              ]),
                                ...
                                Expanded(
                                    child: Column(
                                      ...
                                      customDropdown(
                                          ...
                                          selectedValue:
                                              controller.selectedCivil.value,
                                          validator: (value) {
                                            if (value == null || value.isEmpty)
                    ...
                    child: Column(
                        ...
                        children: [
                              ...
                              child: customDropdown(
                                  ...
                                  validator: (value) =>
                                      (value == null || value.isEmpty)
                                          ...
                                          : null,
                                  onChanged: (data) => controller
                                      .selectedBrgy.value = data.toString())),
                          LuvpayText(
                              text: "Zip Code",
                              style: AppTextStyle.body1(context),
                              color: cs.onSurface),
                          CustomTextField(
                              ...
                              isReadOnly: controller.selectedBrgy.value ==
                                      null ||
                              ...
                              onChange: (_) {
                                controller.zipCode.selection =
                                    TextSelection.fromPosition(TextPosition(
                                        offset:
                                            controller.zipCode.text.length));
                                controller.formKeyStep2.currentState
                                    ?.validate();
                              },
                              validator: (value) {
                                if (value == null || value.isEmpty)
              ...
              Center(
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          color:
                              cs.onSurface.withOpacity(isDark ? 0.20 : 0.12)))),
              spacing(height: 10),
              LuvpayText(
