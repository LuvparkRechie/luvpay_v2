...
class _MyProfileState extends State<MyProfile> {
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                Padding(
                    ...
                    child: Container(
                        ...
                        decoration: BoxDecoration(
                            color:
                                cs.onSurface.withOpacity(isDark ? 0.22 : 0.18),
  ...
  void getProvince(regionId) async {
    ...
    final returnData = await Functions().requestHandler(apiKey: params);
    ...
    if (returnData["items"].isNotEmpty) {
      ...
      province = returnData["items"]
          .where((element) => element["value"] == userData[0]["province_id"])
          .toList()[0]["text"];
      return;
    }
            ...
            child: Padding(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      _buildInfoCard(context,
                          icon: userData["gender"]?.toString().toLowerCase() ==
                                  "m"
                              ? Icons.male_outlined
                              : Icons.female_outlined,
                          title: 'Gender',
                          value: userData["gender"]?.toString().toLowerCase() ==
                                  "m"
                              ? "Male"
                              : "Female"),
                      _buildInfoCard(context,
  ...
  Widget _buildInfoCard(
    ...
    return Container(
        ...
        child: InfoRowTile(
            onTap: () {}, icon: icon, title: title, subtitle: value));
  }
}
